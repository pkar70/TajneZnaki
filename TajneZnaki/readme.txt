...
app "tajemnicze znaki" - mainpage analogicznie do kartownika
* auta
	* rej swiat (DE, FR..)
	* z tabl rej
	* ADR
* tabliczką Z/H (rurociągi)
* mogą być kody pocztowe (wojewodztwa/powiaty), - jeśli coś takiego jest
* tabelka ISO kodów 2, 3 itp literowych
...
* Polska - obrazek tablicy rejestracyjnej
https://pl.wikipedia.org/wiki/Tablice_rejestracyjne_w_Polsce
https://pl.wikipedia.org/wiki/Historyczne_tablice_rejestracyjne_w_Polsce

wyszukiwarka wg powiatu, wg symbolu, symbol: z kbd, albo z spin/rotate/list
może combo pierwszej litery - województwo
kolorki też coś mogą znaczyć


========== ADR
ADR:
https://pl.wikipedia.org/wiki/ADR_(transport)
https://pl.wikipedia.org/wiki/Tablica_ADR
(fotka z wikipedii może być)

wyszukiwarka wg substancji (mianownik), symbolu (z kbd lub rotate/spin/list)


====== tabliczki budynkowe

Tabliczki wodociągowe są białe, oznaczające hydrant – czerwone, a  instalację gazową – żółte.
tablice orientacyjne
H oznacza hydrant, O – odpowietrznik, Z – zasuwę, a Km – kompresor 
...
https://www.znaki24.pl/rurociagi-rury-wodociagi/tabliczki-orientacyjne-dla-gazociagow-jc.html dodaje:
K- kurek
T-odgałęzienie
Pz-punkt załamania

zgodnie z przytoczonymi powyżej normami dla wodociągów stosuje się niebieski opis na białym tle. Wyjątkiem jest oznakowanie hydrantu, dla którego opis jest biały, a tło czerwone. 
...
czyli kolorki i obrazki jak najbardziej (albo: litera kolorem na tle kolorem)
